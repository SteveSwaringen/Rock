        ...
        <asp:Panel ID="pnlView" runat="server" CssClass="panel panel-block">
            ...
            <div class="panel-heading">
                ...
                <div class="pull-right">
                    <asp:LinkButton ID="btnShowFilter" runat="server" CssClass="btn btn-xs btn-default d-print-none" OnClick="btnShowFilter_Click">
            ...
            <asp:Panel ID="pnlFilterCriteria" runat="server" CssClass="panel-heading" Visible="false">
                <div class="row">
                    <div class="col-md-12">
                        <Rock:RockCheckBoxList ID="cblGroups" runat="server" RepeatDirection="Horizontal" Label="Groups" FormGroupCssClass="mb-2" ValidationGroup="vgFilterCriteria" />
                    </div>
                </div>
                <div class="w-100">
                ...
                <div class="grid grid-panel">
                    <Rock:Grid ID="gAttendees" runat="server" DisplayType="Light" UseFullStylesForLightGrid="true" OnRowDataBound="gAttendees_RowDataBound" DataKeyNames="PersonGuid,AttendanceIds" ShowActionRow="false">
                        <Columns>
                            ...
                            <Rock:LinkButtonField ID="btnChangeRoom" HeaderStyle-CssClass="d-print-none" ItemStyle-CssClass="grid-columnaction d-print-none" CssClass="btn btn-default btn-square" Text="<i class='fa fa-external-link-alt'></i>" ToolTip="Change Room" OnClick="btnChangeRoom_Click" />
                        </Columns>
                    </Rock:Grid>
                </div>
        </asp:Panel>
